...
REFS = [
    {"chave": "velocidade", "nome": "Velocidade de pico", "unid": "km/h", "dir": "maior", "alvo": 160,
    ...
    {"chave": "cotovelo", "nome": "Extensão do cotovelo no impacto", "unid": "°", "dir": "maior",
    ...
    {"chave": "joelho", "nome": "Flexão de joelho no carregamento", "unid": "°", "dir": "menor",
    ...
    {"chave": "tronco", "nome": "Inclinação do tronco no impacto", "unid": "°", "dir": "menor",
    ...
    {"chave": "xfactor", "nome": "X-Factor (separação ombro–quadril)", "unid": "°", "dir": "maior",
    ...
    {"chave": "av_ombro", "nome": "Velocidade angular do ombro", "unid": "°/s", "dir": "maior",
    ...
    {"chave": "av_cotovelo", "nome": "Velocidade angular do cotovelo", "unid": "°/s", "dir": "maior",
...
def compare(summary: dict, biomech: dict | None, excluded=None) -> list[dict]:
    """Retorna as linhas de comparação (só métricas com valor disponível).
    `excluded`: chaves de métricas marcadas para não participar da leitura."""
    excluded = excluded or set()
    rows = []
    for r in REFS:
        if r.get("chave") in excluded:
            continue
